...
// Sub-component for fetching runner name
const RunnerInfo = ({ runnerId }: { runnerId?: string }) => {
    ...
    return <span className="text-xs text-blue-600 font-bold bg-blue-50 px-2 py-0.5 rounded-full flex items-center gap-1 w-fit"><UserIcon size={10} /> {runnerName}</span>;
}
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                  <div className="flex flex-col">
                      ...
                      {req.runner_id && <RunnerInfo runnerId={req.runner_id} />}
                  </div>
