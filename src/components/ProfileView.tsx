         ...
         <div className="grid grid-cols-1 gap-3">
          ...
          <div className="mt-6 bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
             ...
             <div className="divide-y divide-gray-50">
                ...
                <button onClick={() => window.dispatchEvent(new CustomEvent('navigate', { detail: 'contact' }))} className="w-full text-left p-4 hover:bg-gray-50 flex justify-between items-center text-gray-600 text-sm font-medium">Need Help? / Support <ChevronRight size={16} className="text-gray-300"/></button>
