...
export default function App() {
  ...
  return (
    <div className="font-sans text-gray-900 animate-scale-in desktop-layout">
        ...
        <main className="p-4 md:p-8 max-w-5xl w-full mx-auto flex-1 pb-24 md:pb-8">
          {view === 'home' && (
             userProfile.role === 'student' ? (
               ...
               <Marketplace requests={requests} onClaim={handleClaim} onUpdateStatus={handleUpdateStatus} userId={user.id} onRefresh={fetchRequests} userProfile={userProfile} />
             )
          )}
      ...
      {showProfileModal && <ProfileModal userProfile={userProfile} onSave={handleSaveProfile} onClose={() => setShowProfileModal(false)} />}
